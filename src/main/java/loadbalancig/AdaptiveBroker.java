...
public class AdaptiveBroker extends DatacenterBrokerSimple {
    ...
    /**
     * Constructs an {@code AdaptiveBroker} instance with a given simulation and
     * an initial VM selection policy.
     *
    ...
    public AdaptiveBroker(CloudSimPlus simulation, VmSelectionPolicy initialPolicy) throws IOException {
        ...
        /**
         * Dynamically registers a listener that reacts to every clock tick. It
         * continuously evaluates live metrics and adjusts scheduling when
         ...
         * </ul>
         *
         * @throws IOException if metric evaluation or configuration access
         * fails.
         */
        super(simulation);
     ...
     *
     * @implNote This method updates average response time, waiting time,
    ...
    /**
     * public List<Cloudlet> getRunningCloudlets() { return
     * getCloudletSubmittedList() .stream() .filter(cl -> cl.getStatus() ==
     * CloudletStatus.INEXEC) .collect(Collectors.toList()); }
     */
    /**
     * Calculates the average response, waiting, and turnaround times for all
     * finished Cloudlets, and updates simulation metrics.
     *
     * @return void
     */
    ...
    /**
     * Computes CPU utilization for all hosts in all datacenters and updates the
     * average datacenter utilization.
     */
    ...
    /**
     * Calculates the number of Cloudlets finished within the deadline and
    ...
    /**
     * Prints summary metrics (response time, throughput, tolerance, etc.) for

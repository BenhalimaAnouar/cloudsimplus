...
/**
 * An interface to be implemented by a VM allocation policy that detects {@link Host} under and over
 * CPU utilization.
 *
...
public sealed interface VmAllocationPolicyMigration extends VmAllocationPolicy
    permits VmAllocationPolicyMigrationDynamicUpperThreshold,
   ...
   * VmAllocationPolicyMigration} objects.
   */
  ...
  /**
   * Checks if a host is currently under utilized, according the conditions defined by the
  ...
  /**
   * Checks if a host is currently over-utilized, according to the conditions defined by the
   * Allocation Policy.
   *
   * @param host the host to check
  ...
  /**
   * Gets a host CPU utilization threshold to detect over utilization. Whether it is a static or
   * dynamically defined threshold depends on each allocation policy implementation.
   *
  ...
  /**
   * Gets the percentage of total Host CPU utilization to indicate when a host is under used, so
   * that its VMs can be migrated elsewhere.
   *
  ...
  /**
   * Sets the percentage of total Host CPU utilization to indicate when a host is under used, so
   * that its VMs can be migrated elsewhere.
   *
   * @param underUtilizationThreshold the under utilization threshold (a percentage value from 0 to
   *     1)
   */
